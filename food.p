...
% If a species is not an apex predator then there is another species that eats it.
...
% If a species is neither a primary producer nor an apex predator, then there is a food chain from a primary producer to that species...
